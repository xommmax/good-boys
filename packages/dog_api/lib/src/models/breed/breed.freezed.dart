...
class _$_Breed implements _Breed {
  ...
  final Map<dynamic, dynamic>? _weight;
  @override
  ...
  final Map<dynamic, dynamic>? _height;
  @override
  ...
  @override
  String toString() {
    return 'Breed(weight: $weight, height: $height, id: $id, name: $name, bredFor: $bredFor, breedGroup: $breedGroup, lifeSpan: $lifeSpan, temperament: $temperament, origin: $origin, referenceImageId: $referenceImageId, image: $image)';
  }
